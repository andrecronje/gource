...
func TestInsertEvent(t *testing.T) {
	...
	t.Run("Check Event Coordinates", func(t *testing.T) {
		...
		if !(e0Event.Body.selfParentIndex == -1 &&
			e0Event.Body.otherParentCreatorIDs[0] == -1 &&
			e0Event.Body.otherParentIndexes[0] == -1 &&
		...
		if !(e21Event.Body.selfParentIndex == 1 &&
			e21Event.Body.otherParentCreatorIDs[0] == p.Participants.ByPubKey[e10Event.Creator()].ID &&
			e21Event.Body.otherParentIndexes[0] == 1 &&
		...
		if !(f1Event.Body.selfParentIndex == 2 &&
			f1Event.Body.otherParentCreatorIDs[0] == p.Participants.ByPubKey[e0Event.Creator()].ID &&
			f1Event.Body.otherParentIndexes[0] == 2 &&
